...
import com.barath.samples.app.MainController;
...
public class WOAGemfireSessionConfiguration {
	
	
	private static final Logger logger=LoggerFactory.getLogger(WOAGemfireSessionConfiguration.class);
	...
	@Bean
	public SessionRepository<ExpiringSession> sessionRepository(ClientCache clientCache){
		...
		return new WOAGemfireSessionRepository(maxInactiveIntervalInSeconds,clientCache);
	}
